...
!(function (t, e) {
  ...
  class Presentjs {
    ...
    diff(input, units, float) {
      ...
      const zoneDelta = (that.utcOffset() - this.utcOffset()) * millisecon_per_minute
      ...
      retsult =
        {
          ...
          [M]: result,
          [Q]: result / 3,
          [W]: (diff - zoneDelta) / millisecon_per_week,
          [D]: (diff - zoneDelta) / millisecon_per_day,
          [H]: (diff - zoneDelta) / millisecon_per_hour,
          [MIN]: (diff - zoneDelta) / millisecon_per_minute,
          [S]: (diff - zoneDelta) / millisecon_per_second,
  ...
  presentjs.unix = (timestamp) => presentjs(timestamp * millisecon_per_second)
